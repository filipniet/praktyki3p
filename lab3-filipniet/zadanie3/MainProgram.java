...
public class MainProgram {
    ...
    public static void main(String[] args){
        ...
        class Student{
            ...
            public Student(String janeczek, String kowalski, LocalDate of, String male) {
            }
       ...
       Student janekKowalski = new Student("janeczek", "kowalski", LocalDate.of(1999, 01, 03), "MALE");
